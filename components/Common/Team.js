                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-sm-6">
                            <div className="single-team active">
                                <div className="team-single-img">
                                    <Image width={0} height={0} src="/../../images/team/team1.png" alt="Image" />

                                    <div className="team-img">
                                        <Image width={0} height={0} src="/../../images/team/team-shape.png" alt="Image" />
                                    </div>
                                </div>
                        ...
                        <div className="col-lg-3 col-sm-6">
                            <div className="single-team active">
                                <div className="team-single-img">
                                    <Image width={0} height={0} src="/../../images/team/team2.png" alt="Image" />
                        ...
                        <div className="col-lg-3 col-sm-6">
                            <div className="single-team active">
                                <div className="team-single-img">
                                    <Image width={0} height={0} src="/../../images/team/team3.png" alt="Image" />
                        ...
                        <div className="col-lg-3 col-sm-6">
                            <div className="single-team active">
                                <div className="team-single-img">
                                    <Image width={0} height={0} src="/../../images/team/team4.png" alt="Image" />
