                            ...
                            <div className="single-news">
                                <div className="blog-img">
                                    <Link legacyBehavior href="/news-details">
                                        <a>
                                            <Image width={0} height={0} src="/../../images/blog/blog1.png" alt="Image" />
                                        </a>
                                    </Link>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-news">
                                <div className="blog-img">
                                    <Link legacyBehavior href="/news-details">
                                        <a>
                                            <Image width={0} height={0} src="/../../images/blog/blog2.png" alt="Image" />
                                        </a>
                                    </Link>
                        ...
                        <div className="col-lg-4 col-md-6 offset-md-3 offset-lg-0">
                            <div className="single-news">
                                <div className="blog-img">
                                    <Link legacyBehavior href="/news-details">
                                        <a>
                                            <Image width={0} height={0} src="/../../images/blog/blog3.png" alt="Image" />
                                        </a>
                                    </Link>
