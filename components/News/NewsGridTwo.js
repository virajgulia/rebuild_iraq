                                    ...
                                    <div className="single-news">
                                        <div className="blog-img">
                                            <Link legacyBehavior href="/news-details">
                                                <a>
                                                    <Image width={0} height={0} src="/../../images/blog/blog4.png" alt="Image" />
                                                </a>
                                            </Link>
                                ...
                                <div className="col-lg-6 col-md-6">
                                    <div className="single-news">
                                        <div className="blog-img">
                                            <Link legacyBehavior href="/news-details">
                                                <a>
                                                    <Image width={0} height={0} src="/../../images/blog/blog5.png" alt="Image" />
                                                </a>
                                            </Link>
                                ...
                                <div className="col-lg-6 col-md-6">
                                    <div className="single-news">
                                        <div className="blog-img">
                                            <Link legacyBehavior href="/news-details">
                                                <a>
                                                    <Image width={0} height={0} src="/../../images/blog/blog6.png" alt="Image" />
                                                </a>
                                            </Link>
                                ...
                                <div className="col-lg-6 col-md-6">
                                    <div className="single-news">
                                        <div className="blog-img">
                                            <Link legacyBehavior href="/news-details">
                                                <a>
                                                    <Image width={0} height={0} src="/../../images/blog/blog7.png" alt="Image" />
                                                </a>
                                            </Link>
                                ...
                                <div className="col-lg-6 col-md-6">
                                    <div className="single-news">
                                        <div className="blog-img">
                                            <Link legacyBehavior href="/news-details">
                                                <a>
                                                    <Image width={0} height={0} src="/../../images/blog/blog8.png" alt="Image" />
                                                </a>
                                            </Link>
                                ...
                                <div className="col-lg-6 col-md-6">
                                    <div className="single-news">
                                        <div className="blog-img">
                                            <Link legacyBehavior href="/news-details">
                                                <a>
                                                    <Image width={0} height={0} src="/../../images/blog/blog9.png" alt="Image" />
                                                </a>
                                            </Link>
