                ...
                <ol className="comment-list">
                        ...
                        <div className="comment-body">
                            <footer className="comment-meta">
                                <div className="comment-author vcard">
                                    <Image width={0} height={0} src="/../../images/blog-details/comment1.jpg" className="avatar" alt="image" />
                        ...
                        <ol className="children">
                            <li className="comment">
                                <div className="comment-body">
                                    <footer className="comment-meta">
                                        <div className="comment-author vcard">
                                            <Image width={0} height={0} src="/../../images/blog-details/comment2.jpg" className="avatar" alt="image" />
                    ...
                    <li className="comment">
                        <div className="comment-body">
                            <footer className="comment-meta">
                                <div className="comment-author vcard">
                                    <Image width={0} height={0} src="/../../images/blog-details/comment3.jpg" className="avatar" alt="image" />
