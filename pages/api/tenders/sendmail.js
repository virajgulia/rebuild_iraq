...
const mandrill_client = new mandrill.Mandrill("E61nWK-7JCnYei9y9DdnQw");
...
handler.get(async (req, res) => {
  ...
  const users = await Users.find({ subscribe: { $ne: false } }).exec();

  const newNews = await News.find({
    createdAt: { $gte: yesterdayTime, $lt: todayTime },
  });

  const newTenders = await Tenders.find({
    createdAt: { $gte: yesterdayTime, $lt: todayTime },
  });
  if (newTenders?.length === 0 && newNews?.length === 0) {
    return res.status(200).json({
      message: "no new tenders and news found",
    });
  }
  ...
  if (newTenders.length > 0) {
    ...
    for (let i = 0; i < newTenders.length; i++) {
      ...
      const elHtml = `<li><a href="${process.env.HOST_NAME}tenders/${tender.slug}" target="_blank">${tender.tenderTitle}</a></li>`;
      listTenderHtml += elHtml;
    }
    listTenderHtml += `</ul>`;
  }
  let listNewsHtml;
  if (newNews.length > 0) {
    listNewsHtml = `<ul>`;
    for (let j = 0; j < newNews.length; j++) {
      const news = newNews[j];
      const alHtml = `<li><a href="${process.env.HOST_NAME}article/${news.slug}" target="_blank">${news.title}</a></li>`;
      listNewsHtml += alHtml;
    }
    listNewsHtml += `</ul>`;
  }
  ...
  if (
    ...
    >
      <tbody>
          ...
          <td
            ...
            "
          >
            <h1 style="font-size: 20px; color:#606060">
            Rebuilding Iraq News Articles for${moment().format("DD/MM/YYYY")}
            </h1>
    ...
    newTenders.length > 0 &&
    newNews.length == 0 &&
    newTenders != undefined &&
    listTenderHtml != undefined
  ) {
    tBodyHtml = `
    <table
      align="left"
    ...
    >
      <tbody>
        ...
        >
          <h1 style="font-size: 20px; color:#606060">
           Rebuilding Iraq Tenders for${moment().format("DD/MM/YYYY")}
          </h1>
    ...
    `;
  } else if (newNews.length > 0 && newTenders.length > 0) {
    tBodyHtml = `
      <table
        align="left"
        border="0"
        ...
        <tr>
          <td align="center" valign="top" id="bodyCell">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer">
                        ...
                        <td valign="top" class="mcnTextBlockInner" style="padding-top: 9px">
                          ...
                          <table align="left" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tbody>                          
                              ...
                              <p>Get Iraq news and tenders sent daily to your inbox - <a href="mailto:mediarelations@ziyen.com?subject=Send%20me%20more%20information%20on%20Rebuilding%20Iraq" target="_blank">sign up</a></p>
                            ...
                            <tbody>
                              <tr>
                                <td class="mcnImageContent" valign="top" style="
                                        ...
                                        text-align: center;
                                      ">
                                  <Image width={0} height={0} align="center" alt="" src="https://firebasestorage.googleapis.com/v0/b/rebuildingiraq-farhan007.appspot.com/o/imgpsh_fullsize_anim.jfif?alt=media&token=964303fe-9199-4867-8d52-ec262527ac9f" style="width: 100%" />
                                </td>
                              </tr>
                            </tbody>
                          </table>
              ...
              <tr>
                <td valign="top" id="templateBody" style="display: flex;">
                <div style="width: 60%">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnTextBlock"
                style="min-width: 100%">
                <tbody class="mcnTextBlockOuter">
            ...
            ${tBodyHtml}
                  ...
                  <button style="border-color: #0949eb;
                  padding: 12px;
                  ...
                  color: white;
                  font-weight: 700;
                  border-radius: 5px;">Register for Daily Tenders in Iraq</button>
                  </td>
                  </tr>
                  <tr>
            <td style="/* padding: 9px; */border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;" class="mcnFollowBlockInner" valign="top" align="center">
                <table class="mcnFollowContentContainer" style="min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;" width="100%" cellspacing="0" cellpadding="0" border="0">
    <tbody><tr>
        <td style="/* padding-left: 9px; *//* padding-right: 9px; */border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;" align="center">
            <table style="min-width: 100%;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;" class="mcnFollowContent" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tbody><tr>
                    <td style="padding-top: 9px;padding-right: 9px;padding-left: 9px;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;" valign="top" align="center">
                        <table cellspacing="0" cellpadding="0" border="0" align="center" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;">
                            <tbody><tr>
                                <td valign="top" align="center" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;">
                                    <!--[if mso]>
                                    ...
                                    <![endif]-->
                                        ...
                                        <![endif]-->
                                            ...
                                            <table class="mcnFollowStacked" style="display: inline;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;" cellspacing="0" cellpadding="0" border="0" align="left">
                                                 
                                                <tbody><tr>
                                                    <td class="mcnFollowIconContent" style="padding-right: 10px;padding-bottom: 9px;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;" valign="top" align="center">
                                                        <a href="http://www.linkedin.com/groups/Rebuilding-Iraq-Iraq-Tenders-Projects-4826802" target="_blank" style="word-wrap: break-word !important;"><Image width={0} height={0} src="https://cdn-images.mailchimp.com/icons/social-block-v2/gray-linkedin-96.png" alt="LinkedIn" class="mcnFollowBlockIcon" style="width: 48px;max-width: 48px;display: block;border: 0;line-height: 100%;outline: none;text-decoration: none;height: auto !important;" width="48"></a>
                                                    </td>
                                                </tr>
                                        ...
                                        <![endif]-->
                                            ...
                                            <table class="mcnFollowStacked" style="display: inline;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;" cellspacing="0" cellpadding="0" border="0" align="left">
                                                ...
                                                <tbody><tr>
                                                    <td class="mcnFollowIconContent" style="padding-right: 10px;padding-bottom: 9px;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;" valign="top" align="center">
                                                        <a href="https://twitter.com/RebuildingIraq" target="_blank" style="word-wrap: break-word !important;"><Image width={0} height={0} src="https://cdn-images.mailchimp.com/icons/social-block-v2/gray-twitter-96.png" alt="Twitter" class="mcnFollowBlockIcon" style="width: 48px;max-width: 48px;display: block;border: 0;line-height: 100%;outline: none;text-decoration: none;height: auto !important;" width="48"></a>
                                                    </td>
                                                </tr>
                                        ...
                                        <![endif]-->
                                            ...
                                            <table class="mcnFollowStacked" style="display: inline;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;" cellspacing="0" cellpadding="0" border="0" align="left">
                                                ...
                                                <tbody><tr>
                                                    <td class="mcnFollowIconContent" style="padding-right: 10px;padding-bottom: 9px;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;" valign="top" align="center">
                                                        <a href="https://www.facebook.com/pages/Rebuilding-Iraq/558922857454107" target="_blank" style="word-wrap: break-word !important;"><Image width={0} height={0} src="https://cdn-images.mailchimp.com/icons/social-block-v2/gray-facebook-96.png" alt="Facebook" class="mcnFollowBlockIcon" style="width: 48px;max-width: 48px;display: block;border: 0;line-height: 100%;outline: none;text-decoration: none;height: auto !important;" width="48"></a>
                                                    </td>
                                                </tr>
                                        ...
                                        <![endif]-->
                                            ...
                                            <table class="mcnFollowStacked" style="display: inline;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;" cellspacing="0" cellpadding="0" border="0" align="left">
                                                ...
                                                <tbody><tr>
                                                    <td class="mcnFollowIconContent" style="padding-right: 10px;padding-bottom: 9px;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;" valign="top" align="center">
                                                        <a href="mailto:hello@rebuildingiraq.net" target="_blank" style="word-wrap: break-word !important;"><Image width={0} height={0} src="https://cdn-images.mailchimp.com/icons/social-block-v2/gray-forwardtofriend-96.png" alt="Email" class="mcnFollowBlockIcon" style="width: 48px;max-width: 48px;display: block;border: 0;line-height: 100%;outline: none;text-decoration: none;height: auto !important;" width="48"></a>
                                                    </td>
                                                </tr>
                                        ...
                                        <![endif]-->
                                            ...
                                            <table class="mcnFollowStacked" style="display: inline;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;" cellspacing="0" cellpadding="0" border="0" align="left">
                                                ...
                                                <tbody><tr>
                                                    <td class="mcnFollowIconContent" style="padding-right: 10px;padding-bottom: 9px;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;" valign="top" align="center">
                                                        <a href="https://plus.google.com/u/0/b/107131693052203682608/" target="_blank" style="word-wrap: break-word !important;"><Image width={0} height={0} src="https://cdn-images.mailchimp.com/icons/social-block-v2/gray-googleplus-96.png" alt="Google Plus" class="mcnFollowBlockIcon" style="width: 48px;max-width: 48px;display: block;border: 0;line-height: 100%;outline: none;text-decoration: none;height: auto !important;" width="48"></a>
                                                    </td>
                                                </tr>
                                        ...
                                        <![endif]-->
                                            ...
                                            <table class="mcnFollowStacked" style="display: inline;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;" cellspacing="0" cellpadding="0" border="0" align="left">
                                                ...
                                                <tbody><tr>
                                                    <td class="mcnFollowIconContent" style="padding-right: 0;padding-bottom: 9px;border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;" valign="top" align="center">
                                                        <a href="http://www.rebuildingiraq.net" target="_blank" style="word-wrap: break-word !important;"><Image width={0} height={0} src="https://cdn-images.mailchimp.com/icons/social-block-v2/gray-link-96.png" alt="Rebuilding Iraq" class="mcnFollowBlockIcon" style="width: 48px;max-width: 48px;display: block;border: 0;line-height: 100%;outline: none;text-decoration: none;height: auto !important;" width="48"></a>
                                                    </td>
                                                </tr>
                ...
                <div style="width: 40%;text-align:center; align-items: center;padding: 10px;margin-top: 30px;border-left: 1px solid #CCCCCC;">
                <Image width={0} height={0} src="https://firebasestorage.googleapis.com/v0/b/rebuildingiraq-farhan007.appspot.com/o/imgpsh_fullsize_anim.png?alt=media&token=9c86e0f9-30ba-48f6-a342-996f29c13129" style="width:75%;">
                <p style="color:#606060;text-align: center;">Featured Rebuilding Iraq<br> Media Partner</p>
                <p style="color:#606060; font-weight: 600;text-align: center;">Al Hurea Security<br> Services </p>
                <a href="http://www.alhurea51.com/">www.alhurea51.com</a>
                <p style="color:#606060;text-align: center;margin-left:20px;margin-right: 20px;">Al Hurea Security Services provides security and risk management solutions for international organisations operating throughout Iraq.  For any company requiring the services of an experienced, mature Private Security Company, Al Hurea (AHSS) is a renowned, fully certified industry leader within Iraq.</p>
                <Image width={0} height={0} src="https://firebasestorage.googleapis.com/v0/b/rebuildingiraq-farhan007.appspot.com/o/imgpsh_fullsize_anim2.png?alt=media&token=2bb4b92f-6a2c-45af-8b9c-7359c0f0dca8" style="width:75%;">
            </div>
                          ...
                          <table align="left" border="0" cellpadding="0" cellspacing="0"
                            ...
                            <tbody>
                              <tr>
                                ...
                                <em>Contact us: info@rebuildingiraq.net</em>  
                                <em>Copyright © * ${moment().format(
                                  "YYYY"
                                )} Ziyen Inc., All rights reserved.</em>
                                  <br />
                                  <br />
                                  <br />
                                  ...
                                  }profile">update your preferences</a>
                                  or
                                  <a href="${
                                    process.env.HOST_NAME
                                  }subscribe">unsubscribe from this list</a>.
                                  <br />
                                  <br />
  ...
  // res.status(200).json({ newTenders, users, text: tBodyHtml });
  // res.set('Content-Type', 'text/html');
  // res.send(Buffer.from(`${templateHtml}`));

  const message = {
    html: templateHtml,
    text: "Tender Alert for " + moment().format("DD/MM/YYYY"),
    subject: "Tender Alert for " + moment().format("DD/MM/YYYY"),
    from_email: "hello@rebuildingiraq.net",
    from_name: "Rebuilding Iraq",
    to: toEmails,
    headers: {
