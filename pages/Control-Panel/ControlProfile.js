...
//alsdf adfj asdl;fjk sa;fj sa;lfkj sa;lfj as;ldfjk
  ...
  return (
    ...
    <>
      {loading ? (
        ...
        <div className="container profie_card_section">
...
export default connect(mapStateToProps, mapDispatchToProps)(ControlProfile);
